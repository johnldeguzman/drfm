...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.followingcounter'
        db.delete_column(u'backendapp_profile', 'followingcounter')

        # Deleting field 'Profile.followerscounter'
        db.delete_column(u'backendapp_profile', 'followerscounter')


    def backwards(self, orm):
        # Adding field 'Profile.followingcounter'
        db.add_column(u'backendapp_profile', 'followingcounter',
                      self.gf('django_counter_field.fields.CounterField')(default=0),
                      keep_default=False)

        # Adding field 'Profile.followerscounter'
        db.add_column(u'backendapp_profile', 'followerscounter',
                      self.gf('django_counter_field.fields.CounterField')(default=0),
                      keep_default=False)
    ...
    models = {
        ...
        u'backendapp.profile': {
            ...
            'postcounter': ('django_counter_field.fields.CounterField', [], {'default': '0'}),
